...
<link href="front/css/font-awesome.css" rel="stylesheet">	<!-- font-awesome icons -->     
<link rel="stylesheet" href="front/css/flexslider.css" type="text/css" media="screen" />  <!-- flexslider-CSS -->  
<link rel="stylesheet" href="front/css/chocolat.css" type="text/css" media="screen"> 
<!-- //Custom Theme files --> 
<!-- js -->
...
<body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top"> 
			...
			<nav class="navbar navbar-default navbar-fixed-top">
				<div class="container">
					<div class="navbar-header page-scroll">
						...
						<h1 class="w3lslogo"><a href="index.html">CW <span>Car World</span></a></h1>
					</div> 
					...
					<ul class="slides">
						<li>
							<div class="banner-w3lstext">  
								...
								<p>“I don’t sell cars; I sell engines. The cars I throw in for free since something has to hold the engines in."</p>
							</div>
						</li>
						<li>
							<div class="banner-w3lstext">  
								<h3>Cars for Sale </h3>
								<p>“There’s three things men always talk about – women, sports, and cars."</p>
							</div>
						</li>
						<li>
							<div class="banner-w3lstext">  
								<h3>Select your own brand</h3>
	...
	<div id="about" class="about">
		<div class="container">
			...
			<img src="front/images/4.png" alt=" " class="img-responsive about-w3img" />
...
?>
							...
							<div class="login-agileits-top"> 	
								...
								<input type="hidden" value="<?php echo $row["id"];?>" name="id">
									<p>User Name </p>
									<input type="text" class="name" value="<?php echo $row["username"];?>" name="username" required=""/>
									<p>Email</p>
									<input type="email" class="email" value="<?php echo $row["email"];?>" name="email" required=""/>
									<p>Password</p>
									<input type="password" class="password" value="<?php echo $row["password"];?>" name="password" required=""/>									
									...
									<?php
									$contry=$row['country'];
									$res1 = $con->query("select * from `countries` where `cont_id`='$contry'");
...
$res3=$con->query("select * from countries" );
																		...
																		{
																		?>	
<option value="<?php echo $row3["cont_id"];?>">
																		
																																			
									<option value="<?php echo $row3['cont_id'];?>"><?php echo $row3['name'];?></option>
									...
									<?php
																		...
																		?>
																		<option  name="state" value="none" selected ><?php echo $row2["sname"];?></option>
...
//alert(country);
			...
			<div class="main">
                <div class="col-sm-4 col-xs-6 gallry-agile-grids">
					<div class="view view-seventh">
						<a href="front/images/g1.jpg" class="b-link-stripe b-animate-go thickbox" title="Car Trade">
				...
				<div class="col-sm-4 col-xs-6 gallry-agile-grids">
					<div class="view view-seventh">
						<a href="front/images/g2.jpg" class="b-link-stripe b-animate-go thickbox" title="Car Trade">
				...
				<div class="col-sm-4 col-xs-6 gallry-agile-grids">
					<div class="view view-seventh">
						<a href="front/images/g3.jpg" class="b-link-stripe b-animate-go thickbox" title="Car Trade">
							<img src="front/images/g3.jpg" alt=""/>
							<div class="mask">
								<h4>Trending Cars</h4>
								<p>Donec efficitur lacus sit amet sollicitudin finibus. Sed tristique nisi augue, sed elementum </p>
							</div>
				...
				<div class="col-sm-4 col-xs-6 gallry-agile-grids">
					<div class="view view-seventh">
						<a href="front/images/g7.jpg" class="b-link-stripe b-animate-go thickbox" title="Car Trade">
				...
				<div class="col-sm-4 col-xs-6 gallry-agile-grids">
					<div class="view view-seventh">
						<a href="front/images/g8.jpg" class="b-link-stripe b-animate-go thickbox" title="Car Trade">
				...
				<div class="col-sm-4 col-xs-6 gallry-agile-grids">
					<div class="view view-seventh">
						<a href="front/images/g9.jpg" class="b-link-stripe b-animate-go thickbox" title="Car Trade">
							<img src="front/images/g9.jpg" alt=""/>
							<div class="mask">
								<h4>Trending Cars</h4>
								<p>Donec efficitur lacus sit amet sollicitudin finibus. Sed tristique nisi augue, sed elementum </p>
							</div>
				...
				<div class="col-sm-4 col-xs-6 gallry-agile-grids">
					<div class="view view-seventh">
						<a href="front/images/g4.jpg" class="b-link-stripe b-animate-go thickbox" title="Car Trade">
							<img src="front/images/g4.jpg" alt=""/>
							<div class="mask">
								<h4>Trending Cars</h4>
								<p>Donec efficitur lacus sit amet sollicitudin finibus. Sed tristique nisi augue, sed elementum </p>
							</div>
				...
				<div class="col-sm-4 col-xs-6 gallry-agile-grids">
					<div class="view view-seventh">
						<a href="front/images/g5.jpg" class="b-link-stripe b-animate-go thickbox" title="Car Trade">
							<img src="front/images/g5.jpg" alt=""/>
							<div class="mask">
								<h4>Trending Cars</h4>
								<p>Donec efficitur lacus sit amet sollicitudin finibus. Sed tristique nisi augue, sed elementum </p>
							</div>
				...
				<div class="col-sm-4 col-xs-6 gallry-agile-grids">
					<div class="view view-seventh">
						<a href="front/images/g6.jpg" class="b-link-stripe b-animate-go thickbox" title="Car Trade">
							<img src="front/images/g6.jpg" alt=""/>
							<div class="mask">
								<h4>Trending Cars</h4>
								<p>Donec efficitur lacus sit amet sollicitudin finibus. Sed tristique nisi augue, sed elementum </p>
							</div>
	...
	<div id="stats" class="stats services news-w3layouts jarallax"> 
		<div class="container">    
			...
			<script type="text/javascript" src="front/js/numscroller-1.0.js"></script>
			<!-- //Progressive-Effects-Animation-JavaScript -->
		</div>
	</div>
	<!-- //Stats -->   
		...
		<div class="container">        
			...
			<div class="blog-agileinfo">
				<div class="col-md-7 blog-w3grid-img">
					<a href="#myModal" data-toggle="modal" class="wthree-blogimg">  
						<img src="front/images/g1.jpg" class="img-responsive" alt=""/>
					</a>  
				</div>
			...
			<div class="blog-agileinfo blog-agileinfo-mdl">
				<div class="col-md-7 blog-w3grid-img blog-img-rght">
					<a href="#myModal" data-toggle="modal" class="wthree-blogimg">  
						<img src="front/images/g2.jpg" class="img-responsive" alt=""/>
					</a>  
				</div>
				<div class="col-md-5 blog-w3grid-text"> 
			...
			<div class="blog-agileinfo">
				<div class="col-md-7 blog-w3grid-img">
					<a href="#myModal" data-toggle="modal" class="wthree-blogimg">  
						<img src="front/images/g3.jpg" class="img-responsive" alt=""/>
					</a>  
				</div>
				<div class="col-md-5 blog-w3grid-text"> 
	...
	<div class="copyw3-agile">
		<div class="container">  
			...
			<p>© 2017 Care Trade. All Rights Reserved | Design by  <a href="http://w3layouts.com/" target="_blank">W3layouts</a> </p>
		</div>
	</div>
	<!-- //copy right end here --> 
	<!-- modal -->
	...
	<script type="text/javascript" src=" front/js/moment-timezone-with-data.js"></script>
	<script type="text/javascript" src="front/js/timer.js"></script>
	<!-- //timer scripts -->
	...
	<!-- //bth hover effect --> 
	<!-- jarallax -->
	<script src="front/js/jarallax.js"></script>
