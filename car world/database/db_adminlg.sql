...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 02, 2023 at 09:39 AM
...
INSERT INTO `tb_insert` (`id`, `carname`, `mfgyear`, `carbrand`, `file`, `fuel`, `discription`) VALUES
(3, 'AUDI R8 V10', '2020', 'Audi', 'audi.jpg', 'Petrol', 'The Audi R8 has 1 Petrol Engine on offer. The Petrol engine is 5204 cc . It is available with Automatic transmission.Depending upon the variant and fuel type the R8 has a mileage of 5.71 kmpl & Ground clearance of R8 is 110mm. The R8 is a 2 seater 10 cylinder car and has length of 4426mm, width of 1940mm and a wheelbase of 2650mm.'),
(12, 'BMW M5', '2018', 'BMW', 'bmwm5.jpg', 'Petrol', 'The BMW M5 has 1 Petrol Engine on offer. The Petrol engine is 4395 cc . It is available with Automatic transmission.Depending upon the variant and fuel type the M5 has a mileage of 9.12 kmpl . The M5 is a 5 seater 8 cylinder car and has length of 4983mm, width of 2126mm and a wheelbase of 2982mm.'),
(13, 'HYUNDAI VERNA', '2023', 'Hyundai', 'verna.jpg', 'Petrol', 'The Hyundai Verna has 2 Petrol Engine on offer. The Petrol engine is 1497 cc and 1482 cc . It is available with Manual & Automatic transmission.Depending upon the variant and fuel type the Verna has a mileage of 18.6 to 20.6 kmpl . The Verna is a 5 seater 4 cylinder car and has length of 4535mm, width of 1765mm and a wheelbase of 2670mm.'),
(14, 'AUDI A8', '2022', 'Audi', 'audia8.jpg', 'Petrol', 'The Petrol engine is 2995 cc . It is available with Automatic transmission. Depending upon the variant and fuel type the A8 has a mileage of 11.7 kmpl . The A8 is a 5 seater 6 cylinder car and has length of 5302mm, width of 1945mm and a wheelbase of 3127mm.'),
(15, 'AUDI RS5', '2020', 'Audi', 'RS5.jpg', 'Petrol', 'The Petrol engine is 2894 cc . It is available with Automatic transmission. Depending upon the variant and fuel type the RS5 has a mileage of 8.8 kmpl . The RS5 is a 4 seater 6 cylinder car and has length of 4783mm, width of 1866mm and a wheelbase of 2832mm.');
...
(1, 'sujith123@gmail.com', 'sujith');

-- --------------------------------------------------------

--
-- Table structure for table `tb_regfrom`
--

CREATE TABLE `tb_regfrom` (
  `id` int(50) NOT NULL,
...
--
-- Dumping data for table `tb_regfrom`
--

INSERT INTO `tb_regfrom` (`id`, `username`, `email`, `password`, `country`, `state`, `status`) VALUES
(5, 'Abeesh', 'abeesh@gmail.com', '12345', 9, 206, 2),
(6, 'sujith', 'sujith@gmail.com', 'sujith', 101, 35, 1),
(7, 'vishnu', 'vishnu@gmail.com', 'vichuzzz', 229, 3798, 0);
...
--
-- Indexes for table `tb_insert`
--
ALTER TABLE `tb_insert`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `tb_regfrom`
--
ALTER TABLE `tb_regfrom`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `tb_insert`
--
ALTER TABLE `tb_insert`
...
--
-- AUTO_INCREMENT for table `tb_regfrom`
--
ALTER TABLE `tb_regfrom`
