				...
				<div class="container">
					...
					<div class="collapse navbar-collapse navbar-ex1-collapse">
						<ul class="nav navbar-nav navbar-right cl-effect-15">
							...
							<li><a class="page-scroll" href="login.php" data-hover="Login">Login</a></li>
						</ul>
					</div>
					<!-- /.navbar-collapse -->
				</div>
		...
		if($count>0)
		{
			...
			while($row=$res->fetch_assoc())
			{
                ...
                <div class="col-sm-4 col-xs-6 gallry-agile-grids">	
					...
					<p>Model Name:<?php echo $row["carname"];?></p>
								<p>Mfg Year:<?php echo $row["mfgyear"];?></p>
								<p>Brand:<?php echo $row["carbrand"];?></p>
								<p>Fuel:<?php echo $row["fuel"];?></p>
								<p>Details:<?php echo substr($row["discription"],0,100);?><a href="car.php ?car=<?php echo $row["id"];?>">read more</a></p>
			         </div>
					 <?php
			}
		}
