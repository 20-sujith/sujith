...
<link rel="stylesheet" href="{{url('public/assets/css/flexslider.css')}}" type="text/css" media="screen" property="" />
	...
	<div class="header">
		...
		<nav class="navbar navbar-default">
			<div class="container">
				...
				<div class="navbar-header">
					...
					<a  href="index.html"><h1>Games <img src="{{url('public/assets/images/c1.png')}}" alt=" " /> Zone</h1></a>
				</div>
		...
		<div class="slider">
			<ul class="rslides" id="slider">
				<li>
					<img src="{{url('public/assets/images/banner3.jpg')}}" alt="" />
				</li>
				<li>
					<img src="{{url('public/assets/images/banner2.jpg')}}" alt="" />
				</li>
				<li>
					<img src="{{url('public/assets/images/banner1.jpg')}}" alt="" />
				</li>
			</ul>
		</div>
		<!-- //Slider -->
		...
		<ul id="flexiselDemo1">			
				<li>
					<div class="trend-grid">
						<h4>Racing Games</h4>
						<img src="{{url('public/assets/images/tg1.jpg')}}" alt=" " class="img-responsive" />
					</div>
				</li>
				<li>
					<div class="trend-grid">
						<h4>3D Games</h4>
						<img src="{{url('public/assets/images/tg2.jpg')}}" alt=" " class="img-responsive" />
					</div>
				</li>
				<li>
					<div class="trend-grid">
						<h4>Action Games</h4>
						<img src="{{url('public/assets/images/tg3.jpg')}}" alt=" " class="img-responsive" />
					</div>
				</li>
				<li>
					<div class="trend-grid">
						<h4>Toy Games</h4>
						<img src="{{url('public/assets/images/tg4.jpg')}}" alt=" " class="img-responsive" />
					</div>
				</li>
			</ul>
...
<div class="new-w3-agile">
	<div class="container">
		...
		<div class="col-md-3 new-grid-w3l view view-eighth">
			<img src="{{url('public/assets/images/ng1.jpg')}}" alt=" " />
			<div class="mask">
		...
		<div class="col-md-3 new-grid-w3l view view-eighth">
			<img src="{{url('public/assets/images/ng2.jpg')}}" alt=" " />
			<div class="mask">
				<a href="single.html"><h4>Click here</h4></a>
				<p>To learn more about this</p>
			</div>
		...
		<div class="col-md-3 new-grid-w3l view view-eighth">
			<img src="{{url('public/assets/images/ng3.jpg')}}" alt=" " />
			<div class="mask">
				<a href="single.html"><h4>Click here</h4></a>
				<p>To learn more about this</p>
			</div>
		...
		<div class="col-md-3 new-grid-w3l view view-eighth">
			<img src="{{url('public/assets/images/ng4.jpg')}}" alt=" " />
			<div class="mask">
				<a href="single.html"><h4>Click here</h4></a>
				<p>To learn more about this</p>
			</div>
		...
		<div class="col-md-3 new-grid-agile view view-eighth">
			<img src="{{url('public/assets/images/ng5.jpg')}}" alt=" " />
			<div class="mask">
				<a href="single.html"><h4>Click here</h4></a>
				<p>To learn more about this</p>
			</div>
		...
		<div class="col-md-3 new-grid-agile view view-eighth">
			<img src="{{url('public/assets/images/ng6.jpg')}}" alt=" " />
			<div class="mask">
				<a href="single.html"><h4>Click here</h4></a>
				<p>To learn more about this</p>
			</div>
		...
		<div class="col-md-3 new-grid-agile view view-eighth">
			<img src="{{url('public/assets/images/ng7.jpg')}}" alt=" " />
			<div class="mask">
				<a href="single.html"><h4>Click here</h4></a>
				<p>To learn more about this</p>
			</div>
		...
		<div class="col-md-3 new-grid-agile view view-eighth">
			<img src="{{url('public/assets/images/ng8.jpg')}}" alt=" " />
			<div class="mask">
				<a href="single.html"><h4>Click here</h4></a>
				<p>To learn more about this</p>
			</div>
				...
				<section class="slider">
					<div class="flexslider">
						...
						<!-- flexSlider -->
							...
							<script defer src="{{url('public/assets/js/jquery.flexslider.js')}}"></script>
							<script type="text/javascript">
							$(window).load(function(){
	...
	<div class="container">
		...
		<div class="col-md-5 footer-middle-w3">
			...
			<div class="col-md-3 img-w3-agile">
				<a href="single.html"><img src="{{url('public/assets/images/ng1.jpg')}}" alt=" " /></a>
			</div>
			<div class="col-md-3 img-w3-agile">
				<a href="single.html"><img src="{{url('public/assets/images/ng2.jpg')}}" alt=" " /></a>
			</div>
			<div class="col-md-3 img-w3-agile">
				<a href="single.html"><img src="{{url('public/assets/images/ng3.jpg')}}" alt=" " /></a>
			</div>
			<div class="col-md-3 img-w3-agile">
				<a href="single.html"><img src="{{url('public/assets/images/ng4.jpg')}}" alt=" " /></a>
			</div>
			<div class="col-md-3 img-w3-agile footer-middle-wthree">
				<a href="single.html"><img src="{{url('public/assets/images/ng5.jpg')}}" alt=" " /></a>
			</div>
			<div class="col-md-3 img-w3-agile footer-middle-wthree">
				<a href="single.html"><img src="{{url('public/assets/images/ng6.jpg')}}" alt=" " /></a>
			</div>
			<div class="col-md-3 img-w3-agile footer-middle-wthree">
				<a href="single.html"><img src="{{url('public/assets/images/ng7.jpg')}}" alt=" " /></a>
			</div>
			<div class="col-md-3 img-w3-agile footer-middle-wthree">
				<a href="single.html"><img src="{{url('public/assets/images/ng8.jpg')}}" alt=" " /></a>
			</div>
			<div class="clearfix"></div>
		</div>
		<div class="col-md-4 footer-right-w3">
			<a href="index.html"><h4>Games <img src="{{url('public/assets/images/f1.png')}}" alt=" " /> Zone</h4></a>
