								...
								<ul>
									<li class="dropdown profile_details_drop">
										...
										<ul class="dropdown-menu drp-mnu">
											...
											<li> <a href="{{url('/logout_action')}}"><i class="fa fa-sign-out"></i> Logout</a> </li>
										</ul>
									</li>
								</ul>
							</div>
                                ...
                                <div class="card-body p-b-20">
                                    <div class="list-group">
                                        <a class="list-group-item media" href="">
                                             <div class="pull-left">
                                                <img class="lg-item-img" src="{{url('public/assets/admin/images/in1.jpg')}}" alt="">
                                            </div>
                                        ...
                                        <a class="list-group-item media" href="">
                                            <div class="pull-left">
                                                <img class="lg-item-img" src="{{url('public/assets/admin/images/in2.jpg')}}" alt="">
                                            </div>
                                            <div class="media-body">
                                                <div class="pull-left">
                                        ...
                                        <a class="list-group-item media" href="">
                                            <div class="pull-left">
                                                <img class="lg-item-img" src="{{url('public/assets/admin/images/in3.jpg')}}" alt="">
                                            </div>
                                            <div class="media-body">
                                                <div class="pull-left">
                                        ...
                                        <a class="list-group-item media" href="">
                                            <div class="pull-left">
                                                <img class="lg-item-img" src="{{url('public/assets/admin/images/in4.jpg')}}" alt="">
                                            </div>
                                            <div class="media-body">
                                            	<div class="pull-left">
...
<!-- Bootstrap Core JavaScript -->
   ...
   <!-- /Bootstrap Core JavaScript -->	   
<!-- morris JavaScript -->	
<script src="{{url('public/assets/admin/js/raphael-min.js')}}"></script>
<script src="{{url('public/assets/admin/js/morris.js')}}"></script>
<script>
	$(document).ready(function() {
